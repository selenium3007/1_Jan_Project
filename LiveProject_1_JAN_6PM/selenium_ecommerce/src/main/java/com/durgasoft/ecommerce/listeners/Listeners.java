...
public class Listeners extends BasePage implements ITestListener {
	...
	public void onTestFailure(ITestResult arg0) {
		...
		if(!arg0.isSuccess())
		{
			...
			File targetPath=new File((String)(reportingDirectory)
					+"/failedscreens/"+methodName+" "+simpleDate.format(cal.getTime())+".png");
			try {
	...
	public void onTestStart(ITestResult arg0) {
		Reporter.log("Test is running: "+arg0.getMethod().getMethodName());
	...
	public void onTestSuccess(ITestResult arg0) {
		...
		if(arg0.isSuccess())
		{
			...
			String reportingDirectory=new File(System.getProperty("user.dir")).getAbsolutePath()
					+"/src/main/java/com/durgasoft/ecommerce";
			File targetPath=new File((String)(reportingDirectory)
					+"/passedscreens/"+methodName+" "+simpleDate.format(cal.getTime())+".png");
			try {
				FileUtils.copyFile(sourcePath, targetPath);
			} catch (IOException e) {
